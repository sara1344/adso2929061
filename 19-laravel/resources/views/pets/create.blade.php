    ...
    <div class="card text-white md:w-[720px] w-[320px] bg-black/20 p-4 mb-4 rounded">
        <form method="POST" action="{{ url('pets') }}" class="flex flex-col md:flex-row gap-4 mt-4 "
            ...
            <div class="w-full md:w-[320px]">
                ...
                <input type="text" class="input bg-[#0009] outline-0" name="name" placeholder="Firulais"
                    value="{{ old('name') }}">
                @error('name')
                    <small class="badge badge-error w-full mt-1 text-xs py-4">{{ $message }}</small>
                @enderror
                ...
                <input type="text" class="input bg-[#0009] outline-0" name="weight" placeholder="10Kg"
                    value="{{ old('weight') }}">
                @error('weight')
                    <small class="badge badge-error w-full mt-1 text-xs py-4">{{ $message }}</small>
                @enderror
                ...
                <input type="text" class="input bg-[#0009] outline-0" name="age" placeholder="10Kg"
                    value="{{ old('age') }}">
                @error('age')
                    <small class="badge badge-error w-full mt-1 text-xs py-4">{{ $message }}</small>
                @enderror
                ...
                <input type="text" class="input bg-[#0009] outline-0" name="location" placeholder="City, State"
                    value="{{ old('location') }}">
                @error('location')
                    <small class="badge badge-error w-full mt-1 text-xs py-4">{{ $message }}</small>
                @enderror
                ...
                <textarea class="textarea bg-[#0009] outline-0" name="description" placeholder="Describe your pet...">{{ old('description') }}</textarea>
                @error('description')
                    <small class="badge badge-error w-full mt-1 text-xs py-4">{{ $message }}</small>
                @enderror
                {{-- active --}}
